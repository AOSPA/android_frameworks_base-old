...
interface ISecureAppsService {
    ...
    void readState(AtomicBoolean enabled);
    ...
    void onAppWindowRemoved(in String packageName, WindowState w);

    void updateAppVisibility(in String packageName);

    void promptIfNeeded(in String packageName, WindowState w);
