...
public final class ActivityThread {
    ...
    private int getHybridDpi(int defaultDpi) {   
        if (mCurrentProp != null) {
            final int dpi  = mCurrentProp.getDpi();
    ...
    private void hybridHook(String packageName) {
        if (sHybridManager != null) {
            ...
            mCurrentProp = sHybridManager.setPackageNameForResult(packageName);
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        mConfiguration = getHybridConfiguration(new Configuration(data.config));
        mCompatConfiguration = getHybridConfiguration(new Configuration (data.config));
