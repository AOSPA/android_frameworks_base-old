...
public class HybridManager {
    ...
    */
    ...
    public HybridProp setPackageNameForResult(String packageName) {
        try {
           return mService.setPackageName();
        } catch (RemoteException ex) {
            if (DEBUG) Log.e(TAG, "Error getting HybridProp for result:" + ex.toString());
        }
        return new HybridProp(packageName);
    }
