...
public class BatteryChargeCalculator extends PowerCalculator {
    ...
    public void calculate(BatteryUsageStats.Builder builder, BatteryStats batteryStats,
        ...
        int batteryCapacityMahDivider = Resources.getSystem().getInteger(
                com.android.internal.R.integer.config_batteryCapacityMahDivider);
        int batteryCapacityMah = batteryStats.getLearnedBatteryCapacity() / batteryCapacityMahDivider;
