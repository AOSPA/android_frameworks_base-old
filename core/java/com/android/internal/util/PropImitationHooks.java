...
public class PropImitationHooks {
    ...
    private static final Boolean sDisablePropImitation =
            SystemProperties.getBoolean("persist.sys.propimitation.disable", false);
    ...
    public static void setProps(Context context) {
        if (sDisablePropImitation) {
            dlog("Prop imitation is disabled by user");
            return;
        }
