...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            // if we have just disable immersive bring navbar view on screen, previous check
            // at requestTransientBars() returns false for triggerNavbar.
            boolean navBarHidden = mNavigationBarController.checkShowTransientBarLw();
            if (mImmersiveModeStyle == IMMERSIVE_MODE_OFF && navBarHidden) mNavigationBarController.showTransient();
