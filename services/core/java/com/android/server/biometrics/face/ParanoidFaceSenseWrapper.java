...
import com.android.server.biometrics.face.ParanoidFaceService.FaceServiceListener;

public class ParanoidFaceSenseWrapper {

    private static ParanoidFaceSenseWrapper sInstance;
    ...
    private ParanoidFaceSenseWrapper(Context context) {
        if (context != null) {
            mContext = context;
        }
    }

    public static ParanoidFaceSenseWrapper getInstance(Context context) {
        if (sInstance == null && context != null) {
            sInstance = new ParanoidFaceSenseWrapper(context);
        }
        return sInstance;
    }
