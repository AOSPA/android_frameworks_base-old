    ...
    /*package*/ void handleBluetoothA2dpActiveDeviceChangeExt(
          ...
          if (state == BluetoothProfile.STATE_DISCONNECTED) {
              mDeviceBroker.queueOnBluetoothActiveDeviceChanged(
                  new AudioDeviceBroker.BtDeviceChangedData(null, device, new BtProfileConnectionInfo(profile), "AudioDeviceInventory"));
          ...
          if (state == BluetoothProfile.STATE_CONNECTED && profile == BluetoothProfile.A2DP_SINK) {
              mDeviceBroker.queueOnBluetoothActiveDeviceChanged(
                  new AudioDeviceBroker.BtDeviceChangedData(device, null, new BtProfileConnectionInfo(profile), "AudioDeviceInventory"));
              return;
          }
