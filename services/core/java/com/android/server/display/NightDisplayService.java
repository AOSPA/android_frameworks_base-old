...
public final class NightDisplayService extends SystemService
        ...
        try {
            if (mIsAdaptiveBrightness) {
                ...
                if (activated) {
                    ...
                    float previousAdaptiveBrightness = Settings.Secure.getFloatForUser(cr,
                            Settings.Secure.ADAPTIVE_BRIGHTNESS_PREVIOUS_USERVALUE, 0,
                            mCurrentUser);
                    Settings.System.putFloatForUser(cr,
                            Settings.System.SCREEN_AUTO_BRIGHTNESS_ADJ, previousAdaptiveBrightness,
                            mCurrentUser);
                }
            } else {
                ...
                if (activated) {
                    ...
                    int previousManualBrightness = Settings.Secure.getIntForUser(cr,
                            Settings.Secure.MANUAL_BRIGHTNESS_PREVIOUS_USERVALUE, 0,
                            mCurrentUser);
                    Settings.System.putIntForUser(cr,
                            Settings.System.SCREEN_BRIGHTNESS, previousManualBrightness,
                            mCurrentUser);
                }
            }
        } catch (RemoteException e) {
    ...
    public void updateBrightnessModeValues() {
        ...
        float userAdaptiveBrightness = Settings.System.getFloatForUser(cr,
                Settings.System.SCREEN_AUTO_BRIGHTNESS_ADJ, 0,
                mCurrentUser);
        Settings.Secure.putFloatForUser(cr,
                Settings.Secure.ADAPTIVE_BRIGHTNESS_PREVIOUS_USERVALUE, userAdaptiveBrightness,
                mCurrentUser);
        int userManualBrightness = Settings.System.getIntForUser(cr,
                Settings.System.SCREEN_BRIGHTNESS, 0,
                mCurrentUser);
        Settings.Secure.putIntForUser(cr,
                Settings.Secure.MANUAL_BRIGHTNESS_PREVIOUS_USERVALUE, userManualBrightness,
                mCurrentUser);
