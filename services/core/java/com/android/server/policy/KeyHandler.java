...
public class KeyHandler {
    ...
    private void handleGesture(int gesture) {
        ...
        switch(gesture) {
            ...
            case MUSIC_PLAY_PAUSE:
                doHapticFeedback(dispatchMediaKeyWithWakeLockToMediaSession(KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE));
                break;
            case TORCH:
                doHapticFeedback(setTorchMode(!mTorchEnabled));
                break;
            case MUSIC_PREVIOUS:
                if (isMusicActive()) {
                    doHapticFeedback(dispatchMediaKeyWithWakeLockToMediaSession(KeyEvent.KEYCODE_MEDIA_PREVIOUS));
                } else {
            ...
            case MUSIC_NEXT:
                if (isMusicActive()) {
                    doHapticFeedback(dispatchMediaKeyWithWakeLockToMediaSession(KeyEvent.KEYCODE_MEDIA_NEXT));
                } else {
                    doHapticFeedback(false);
                }
                break;
    ...
    protected void isDeviceInPocket(boolean isInPocket) {
