...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        WindowState fullscreenTransWin = (mSystemDesignFlags
                & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_STATUS) == 0
                && isStatusBarKeyguard() && !mHideLockScreen ? mStatusBar : mTopFullscreenOpaqueWindowState;
