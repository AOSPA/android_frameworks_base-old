...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void showPocketOverlayIfNeeded() {
        if (mSystemReady && mSystemBooted /* && proximity positive */) {
    ...
    private class PocketView extends LinearLayout {
