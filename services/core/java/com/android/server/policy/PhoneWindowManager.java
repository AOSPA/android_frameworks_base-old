...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void handleShortPressOnKeyCode(int keyCode) {
        Log.i(TAG, "CARLO; " + "handleShortPressOnKeyCode: " + ", keyCode=" + keyCode);
    ...
    private void handleLongPressOnKeyCode(int keyCode) {
        ...
        Log.i(TAG, "CARLO; " + "handleLongPressOnKeyCode: " + ", longPressBehavior=" + longPressBehavior);
    ...
    private void handleDoubleTapOnKeyCode(int keyCode) {
        ...
        Log.i(TAG, "CARLO; " + "handleDoubleTapOnKeyCode: " + ", doubleTapBehavior=" + doubleTapBehavior);
