...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void interceptPowerKeyDown(KeyEvent event, boolean interactive) {
        ...
        boolean pocket = interactive && mPocketLock != null && mPocketLock.isShowing();
    ...
    private void powerPress(long eventTime, boolean interactive, int count) {
        ...
        if (count == 2) {
            final boolean pocket = interactive && mPocketLock != null && mPocketLock.isShowing();
            if (pocket) {
...
//        showPocketLockIfNeeded();
    ...
    private class PocketLock {
        ...
        private void setWindowManagerParams() {
            ...
            this.mLayoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE
                    | WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE
