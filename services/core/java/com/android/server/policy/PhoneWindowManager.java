...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void handleShortPressOnKeyCode(int keyCode) {
        ...
        runKeyCodeDefaultBehaviorAction(keyCode);
    }
    ...
    /**
     * List of possible key codes to intercept if custom
     * behavior is defined.
     */
    static final int[] SUPPORTED_HARDWARE_KEY_CODES = {
     ...
     */
    private boolean isKeyCodeConsumed(int keyCode) {
     ...
     * @param keyCode the KeyEvent key code.
     */
    private void setKeyCodeConsumed(int keyCode, boolean consumed) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_HOME:
     ...
     * @param keyCode the KeyEvent key code.
     */
    private void setKeyCodePressed(int keyCode, boolean pressed) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_HOME:
     ...
     * @param keyCode the KeyEvent key code.
     */
    private void setKeyCodeDoubleTapPending(int keyCode, boolean pending) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_HOME:
     ...
     * @param keyCode the KeyEvent key code.
     */
    private int getKeyCodeDoubleTapBehavior(int keyCode) {
        int behavior = -1;
        switch (keyCode) {
            case KeyEvent.KEYCODE_HOME:
     ...
     * @param keyCode the KeyEvent key code.
     */
    private Runnable getKeyCodeDoubleTapTimeoutRunnable(int keyCode) {
     ...
     * @param keyCode the KeyEvent key code.
     */
    private int getKeyCodeLongPressBehavior(int keyCode) {
        int behavior = -1;
        switch (keyCode) {
            case KeyEvent.KEYCODE_HOME:
     ...
     * @param keyCode the KeyEvent key code.
     */
    private boolean isKeyCodeDoubleTapPending(int keyCode) {
    ...
    private boolean isSupported(int keyCode) {
        ...
        int length = SUPPORTED_HARDWARE_KEY_CODES.length;
        for (int i = 0; i < length; i++) {
            if (SUPPORTED_HARDWARE_KEY_CODES[i] == keyCode) {
                supported = true;
                break;
            }
        }
     ...
     */
    private void runKeyCodeBehaviorAction(int keyCode, int behavior) {
        switch(behavior) {
     ...
     * @param keyCode the KeyEvent key code.
     */
    private void runKeyCodeDefaultBehaviorAction(int keyCode) {
        switch(keyCode) {
            case KeyEvent.KEYCODE_HOME:
                launchHomeFromHotKey();
                break;
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        // Custom event handling for specific key codes.
        if (isSupported(keyCode) && source != InputDevice.SOURCE_CUSTOM
                && !navBarKey /* && !virtualKey */) {
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        // Apply custom policy for specific key codes.
        if (isSupported(keyCode) && source != InputDevice.SOURCE_CUSTOM
                && !navBarKey /* && !virtualKey */) {
            if (mNavBarEnabled) {
                if (DEBUG_INPUT) {
