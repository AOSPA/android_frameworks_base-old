...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        if ((mSystemDesignFlags & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_NAV) != 0
                && !mForcingShowNavBar && !isStatusBarKeyguard()) {
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        if (((mSystemDesignFlags & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_NAV) != 0
                || (mSystemDesignFlags & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_STATUS) != 0)
                && isStatusBarKeyguard() && !mHideLockScreen) {
            fullscreenTransWin = mTopFullscreenOpaqueWindowState;
        } else if (((mSystemDesignFlags & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_NAV) == 0
                || (mSystemDesignFlags & View.SYSTEM_DESIGN_FLAG_IMMERSIVE_STATUS) == 0)
                && isStatusBarKeyguard() && !mHideLockScreen) {
            fullscreenTransWin = mStatusBar;
        } else {
            fullscreenTransWin = mTopFullscreenOpaqueWindowState;
        }
