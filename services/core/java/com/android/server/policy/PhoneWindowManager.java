...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void interceptPowerKeyDown(KeyEvent event, boolean interactive) {
        ...
        boolean blockAllTheThings = interactive && isPocketLockShwowing();
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        boolean isPocketLockShowing = isPocketLockShwowing();
    ...
    private boolean isPocketLockShwowing() {
        return mPocketLock != null && mPocketLock.isShowing();
    }

    private void showPocketLockIfNeeded() {
        if (!mSystemReady || !mSystemBooted || mPocketLock == null) {
            return;
        }
