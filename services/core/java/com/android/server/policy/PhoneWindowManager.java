...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public int getNonDecorDisplayWidth(int fullWidth, int fullHeight, int rotation, int uiMode,
        ...
        if (displayId == DEFAULT_DISPLAY && mHasNavigationBar
                && mNavigationBar != null && !shouldForceNavigationBarImmersive()) {
    ...
    public void beginLayoutLw(boolean isDefaultDisplay, int displayWidth, int displayHeight,
        ...
        if (isDefaultDisplay) {
            ...
            if (!mUsingEdgeGestureServiceForGestures && mHasNavigationBar) {
    ...
    private boolean layoutStatusBar(Rect pf, Rect df, Rect of, Rect vf, Rect dcf, int sysui,
        ...
        if (mStatusBar != null) {
            final boolean hasNavBar = mHasNavigationBar && mNavigationBar != null;
            final boolean forceNavBarImmersive =  shouldForceNavigationBarImmersive();
    ...
    public boolean isNavBarForcedShownLw(WindowState windowState) {
        return mForceShowSystemBars && mHasNavigationBar && !shouldForceNavigationBarImmersive();
    }
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        if (!mUsingEdgeGestureServiceForGestures && !forceNavBarImmersive
                && hideNavBarSysui && !navAllowedHidden && getWindowLayerLw(win)
                > getWindowLayerFromTypeLw(TYPE_INPUT_CONSUMER)) {
