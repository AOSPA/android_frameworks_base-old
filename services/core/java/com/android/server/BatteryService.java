...
public final class BatteryService extends SystemService {
    ...
    private void sendBatteryChangedIntentLocked() {
        ...
        intent.putExtra(BatteryManager.EXTRA_REMAINING_CAPACITY, mHealthInfo.batteryFullChargeUah);
    ...
    private void sendBatteryLevelChangedIntentLocked() {
        ...
        event.putExtra(BatteryManager.EXTRA_REMAINING_CAPACITY, mHealthInfo.batteryFullChargeUah);
        event.putExtra(BatteryManager.EXTRA_DESIGN_CAPACITY, mHealthInfo.batteryFullChargeDesignCapacityUah);
