...
public class Smart5gService extends SystemService {
    ...
    private boolean mIsMobileDataActive, mIsPowerSaveMode, mInternetConnected;
    ...
    private final ConnectivityManager.NetworkCallback mNetworkCallback =
        ...
        private void refresh() {
            mInternetConnected = !mNetworkCaps.isEmpty();
            mIsMobileDataActive = mNetworkCaps.values().stream()
    ...
    private boolean shouldDisable5g(int subId) {
        ...
        dlog("shouldDisable5g: subId=" + subId + " mIsPowerSaveMode=" + mIsPowerSaveMode
                ...
                + mDefaultDataSubId + " mInternetConnected=" + mInternetConnected);
        return mIsPowerSaveMode // battery saver mode
                || (!mIsMobileDataActive && mInternetConnected) // we aren't on mobile data
