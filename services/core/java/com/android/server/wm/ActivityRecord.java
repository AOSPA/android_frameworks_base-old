...
public final class ActivityRecord extends ConfigurationContainer {
    ...
    boolean isAppSecured; // The activity is secured/locked with authentication
    ...
    ActivityRecord(ActivityTaskManagerService _service, WindowProcessController _caller,
        ...
        isAppSecured = mAtmService.isAppSecured(packageName);
    ...
    public void onWindowsDrawn(boolean drawn, long timestamp) {
        synchronized (mAtmService.mGlobalLock) {
            ...
            mAtmService.getSecureAppsService().onWindowsDrawn(packageName);
            final WindowingModeTransitionInfoSnapshot info = mStackSupervisor
    ...
    ActivityTaskManagerService getAtmService() {
        return mAtmService;
    }
