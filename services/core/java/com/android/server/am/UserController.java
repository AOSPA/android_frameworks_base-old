...
final class UserController {
    ...
    private final int BOOST_ON_BOOT_DEFAULT_DURATION = 40 * 1000; // 40 seconds
    ...
    private void finishUserUnlockedCompleted(UserState uss) {
        ...
        if (lIsPerfBoostEnabled) {
            ...
            mBoostDuration = mService.mContext.getResources().getInteger(
                    com.android.internal.R.integer.onbootboost_timeout_param);
            ...
            Slog.w(TAG, "PERF YO YO duration: " + mBoostDuration);
