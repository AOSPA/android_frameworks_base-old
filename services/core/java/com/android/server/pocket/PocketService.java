...
public class PocketService extends SystemService implements IBinder.DeathRecipient {
    ...
    private static final boolean ENABLE_LIGHT_SENSOR = true;
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (DEBUG) {
                ...
                try {
                    ...
                    final float maxRange = mLightSensor.getMaximumRange();
                    Log.d(TAG, "Event: value=" + sensorEvent.values[0] + ", maxRange=" + maxRange
                            + ", time=" + time + ", lux= " + lux);
                } catch (NullPointerException e) {
                    Log.e(TAG, "Ops! Something went wrong: exception = " + e);
                }
            }
        }
