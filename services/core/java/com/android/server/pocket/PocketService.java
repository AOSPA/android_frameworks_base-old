...
public class PocketService extends SystemService implements IBinder.DeathRecipient {
    ...
    /**
     * Light sensor minimum and maximum value registered in pocket with semi-transparent fabric.
     * TODO> Better per device values and/or formula to calculate it.
     */
    private static final float LIGHT_POOR_MIN_TRESHOLD = 0.0f;
    private static final float LIGHT_POOR_MAX_TRESHOLD = 1.0f;
    ...
    public PocketService(Context context) {
        ...
        mEnabled = System.getIntForUser(mContext.getContentResolver(),
                POCKET_JUDGE, 1 /*default */, UserHandle.USER_CURRENT) != 0;
        mContext.getContentResolver().registerContentObserver(
                System.getUriFor(POCKET_JUDGE),
                true, mPocketObserver);
    }

    private final ContentObserver mPocketObserver = new ContentObserver(mHandler) {
        @Override
    ...
    public void binderDied() {
        ...
        mContext.getContentResolver().unregisterContentObserver(mPocketObserver);
    }
    ...
    private void handleLightSensorEvent(SensorEvent sensorEvent) {
        ...
        try {
            if (sensorEvent == null) {
                ...
                final boolean isPoor = value >= LIGHT_POOR_MIN_TRESHOLD
                        && value <= LIGHT_POOR_MAX_TRESHOLD
                        && value <= mLightMaxRange;
    ...
    private void dumpInternal(PrintWriter pw) {
        ...
        try {
            ...
            dump.put("wasDeviceInPocket", wasDeviceInPocket());
