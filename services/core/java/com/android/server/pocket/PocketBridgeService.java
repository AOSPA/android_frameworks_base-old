...
public class PocketBridgeService extends SystemService {
    ...
    private static final String SYSFS_INPOCKET = "/sys/kernel/pocket_judge/inpocket";
    ...
    private class PocketBridgeHandler extends Handler {
        ...
        public PocketBridgeHandler(Looper looper) {
            ...
            try {
                mFileOutputStream = new FileOutputStream(SYSFS_INPOCKET);
		...
		// Log.d(TAG, "Write to sysfs, mIsDeviceInPocket = " + (mIsDeviceInPocket ? "true" : "false"));
	    }
        }
