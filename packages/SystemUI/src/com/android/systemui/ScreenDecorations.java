...
public class ScreenDecorations extends SystemUI implements Tunable {
    ...
    public static class DisplayCutoutView extends View implements DisplayManager.DisplayListener,
        ...
        private int getGravity(DisplayCutout displayCutout) {
            ...
            if (mPosition == BOUNDS_POSITION_LEFT) {
                if ((displayCutout != null && !displayCutout.getBoundingRectLeft().isEmpty()) || hasUnderDisplayCamera) {
                    return Gravity.LEFT;
                }
            } else if (mPosition == BOUNDS_POSITION_TOP) {
                if ((displayCutout != null && !displayCutout.getBoundingRectTop().isEmpty()) || hasUnderDisplayCamera) {
                    return Gravity.TOP;
                }
            } else if (mPosition == BOUNDS_POSITION_BOTTOM) {
                if ((displayCutout != null && !displayCutout.getBoundingRectBottom().isEmpty()) || hasUnderDisplayCamera) {
                    return Gravity.BOTTOM;
                }
            } else if (mPosition == BOUNDS_POSITION_RIGHT) {
                if ((displayCutout != null && !displayCutout.getBoundingRectRight().isEmpty()) || hasUnderDisplayCamera) {
                    return Gravity.RIGHT;
                }
            }
        ...
        public boolean shouldInterceptTouch() {
            return (hasUnderDisplayCamera(getContext()) || mInfo.displayCutout != null) && getVisibility() == VISIBLE;
        }
