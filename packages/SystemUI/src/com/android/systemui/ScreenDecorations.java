...
public class ScreenDecorations extends SystemUI implements Tunable,
    ...
    private void updateViews() {
        ...
        if (mRotation == RotationUtils.ROTATION_NONE) {
            ...
            updateView(topLeft, Gravity.TOP | Gravity.LEFT, mCustomCutout ? 0 : 0);
            ...
            updateView(topLeft, Gravity.BOTTOM | Gravity.LEFT, mCustomCutout ? 270 : 270);
            ...
            updateView(bottomRight, Gravity.TOP | Gravity.RIGHT, mCustomCutout ? 90 : 90);
        } else if (mRotation == RotationUtils.ROTATION_SEASCAPE) {
            updateView(topLeft, Gravity.BOTTOM | Gravity.RIGHT, mCustomCutout ? 180 : 180);
            updateView(topRight, Gravity.TOP | Gravity.RIGHT, mCustomCutout ? 0 : 90);
            updateView(bottomLeft, Gravity.BOTTOM | Gravity.LEFT, mCustomCutout ? 0 : 270);
