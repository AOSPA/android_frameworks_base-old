...
public class BatteryMeterView extends LinearLayout implements
    ...
    private static final int BATTERY_STYLE_BAR = 0;
    private static final int BATTERY_STYLE_CIRCLE = 1;
    private static final int BATTERY_STYLE_FULL_CIRCLE = 2;
    ...
    public int mBatteryStyle = BATTERY_STYLE_BAR;
    ...
    private void scaleBatteryMeterViews() {
        ...
        int batteryHeight = mBatteryStyle == BATTERY_STYLE_CIRCLE || mBatteryStyle == BATTERY_STYLE_FULL_CIRCLE
        ...
        int batteryWidth = mBatteryStyle == BATTERY_STYLE_CIRCLE || mBatteryStyle == BATTERY_STYLE_FULL_CIRCLE
                ? res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_circle_width)
