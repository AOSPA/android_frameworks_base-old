...
public class UdfpsController implements DozeReceiver, UdfpsHbmProvider {
    ...
    public UdfpsController(@NonNull Context context,
        ...
        mSecureSettings.registerContentObserver(Settings.Secure.SCREEN_OFF_UDFPS,
            new ContentObserver(mMainHandler) {
                @Override
                public void onChange(boolean selfChange, Uri uri) {
                    if (uri.getLastPathSegment().equals(Settings.Secure.SCREEN_OFF_UDFPS)) {
                        updateScreenOffUdfpsState();
                    }
                }
            }
    ...
    private void updateScreenOffUdfpsState() {
        ...
        mScreenOffUdfps = isSupported && mSecureSettings.getInt(Settings.Secure.SCREEN_OFF_UDFPS, 0) == 1;
    }
