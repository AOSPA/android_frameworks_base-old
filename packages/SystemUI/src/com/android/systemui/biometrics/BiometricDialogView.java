...
public abstract class BiometricDialogView extends LinearLayout {
    ...
    public void onAttachedToWindow() {
        ...
        if (TextUtils.isEmpty(descriptionText)) {
            ...
            if (mAppLockDialog) {
                ...
                descriptionText += " is Locked.\n" + negText + ((mIsFingerprint && mIsFace) ? ", fingerprint or your face to unlock."
                        : (mIsFace) ? " or your face to unlock." : " or your fingerprint to unlock.");
            }
    ...
    public void setFaceAndFingerprint(boolean isFace, boolean isFingerprint) {
        ...
        if (mIsFingerprint) {
            ...
            if (mHasFod) {
                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mErrorText.getLayoutParams();
                lp.bottomMargin = -mErrorText.getPaddingBottom();
