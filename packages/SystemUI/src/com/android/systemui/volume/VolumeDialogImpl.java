...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void initDialog() {
        ...
        Util.setVisOrGone(mMediaOutputView, true);
            ...
            mExpandRows.setOnClickListener(v -> {
                if (!mExpanded) {
                    ...
                    if (mTelephonyManager.getCallState() == TelephonyManager.CALL_STATE_IDLE) {
                        ...
                        animateView(mMediaOutputScrollView, true, width, mElevation, false);
                    }
                    if (alarm != null) {
    ...
    public void onDeviceListUpdate(List<MediaDevice> devices) {
        ...
        for (int i = 0; i < N; i++) {
            final MediaDevice device = devices.get(i);
            ...
            if (device.isConnected()) {
                if (row == null) {
                    ...
                    row.view.setOnClickListener(v -> {
                            mHandlerSecondary.post(() -> mLocalMediaManager.connectDevice(device));
                    });
