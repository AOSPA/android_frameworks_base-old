...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    public VolumeDialogImpl(Context context) {
        ...
        mSpacer = (float) mContext.getResources().getDimension(R.dimen.volume_dialog_row_spacer);
    ...
    public void initSettingsH() {
        ...
        if (mExpandRows != null) {
            mMediaButton.setOnClickListener(v -> {
                ...
                if (mShowingMediaDevices) {
                    mShowingMediaDevices = false;
                    int x = (int) (isLandscape() ? (isAudioPanelOnLeftSide() ? (mWidth + mSpacer) * 2 +
                        (mHasAlertSlider ? mWidth/2 : mWidth ) : (mHasAlertSlider ? mWidth/2 : 0 )) :
                        (1.5 * mWidth + mSpacer));
