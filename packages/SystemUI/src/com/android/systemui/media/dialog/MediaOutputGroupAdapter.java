...
public class MediaOutputGroupAdapter extends MediaOutputBaseAdapter {
    ...
    class GroupViewHolder extends MediaDeviceBaseViewHolder {
        ...
        void onBind(MediaDevice device, boolean topMargin, boolean bottomMargin, int position) {
            ...
            setSingleLineLayout(getItemTitle(device), true /* bFocused */, true /* showSeekBar */,
        ...
        void onBind(int customizedItem, boolean topMargin, boolean bottomMargin) {
            ...
            if (customizedItem == CUSTOMIZED_ITEM_GROUP) {
                setSingleLineLayout(mContext.getText(R.string.media_output_dialog_group),
                        false /* bFocused */, true /* showSeekBar */, false /* showProgressBar */,
                        false /* showSubtitle*/);
