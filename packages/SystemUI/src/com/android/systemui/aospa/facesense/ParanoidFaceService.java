...
public class ParanoidFaceService {
    ...
    protected static final TAG = "ParanoidFaceService";
    ...
    public void setTimeoutFail(int i) {
        if (!mFaceUnlockHandler.hasMessages(2)) {
            Log.d(TAG, "setTimeoutFail: " + i);
            mFaceUnlockHandler.sendEmptyMessageDelayed(2, (long) i);
        }
    }
    ...
    public void startCameraAndDetectFace() {
        ...
        mFaceUnlockHandler.removeMessages(3);
        mFaceUnlockHandler.removeMessages(1);
    ...
    public void stopCameraAndDetectFace() {
        ...
        mFaceUnlockHandler.removeMessages(1);
        mFaceUnlockHandler.removeMessages(3);
        mFaceUnlockHandler.sendEmptyMessage(3);
    }

    public void bindFaceUnlockService() {
        Log.d(TAG, "bindFaceUnlockService");
        mFaceUnlockHandler.removeMessages(5);
        mFaceUnlockHandler.removeMessages(4);
        mFaceUnlockHandler.sendEmptyMessage(5);
    }

    public void unbindFaceUnlockService() {
        Log.d(TAG, "unbindFaceUnlockService");
        mFaceUnlockHandler.removeMessages(4);
        mFaceUnlockHandler.sendEmptyMessageDelayed(4, 3000);
    }
