...
public class PieMenu extends RelativeLayout {
    ...
    private void getDimensions() {
        ...
        mToggleOutsideAnimator.addUpdateListener(new AnimatorUpdateListener() {
            @Override
        ...
        mToggleOutsideAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                // Is less than the full animation time, without this check it will still
                // Execute switchSnapPoints(). Fix it.
    ...
    private void switchSnapPoints() {
        // mToggleGrowAnimator anim speed - mToggleOutsideAnimator anim speed(385-250) + 10ms = 145
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (mOpen) {
            ...
            for (int i = 0; i < mNumberOfTogglePoints; i++) {
                ...
                float toggleOutSideAnimatorFraction =
