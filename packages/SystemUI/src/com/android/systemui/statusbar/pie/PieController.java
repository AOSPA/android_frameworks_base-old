...
public class PieController extends EdgeGestureManager.EdgeGestureActivationListener {
    ...
    private void createItems() {
        ...
        mBack = makeItem(R.drawable.ic_sysbar_back, res.getColor(R.color.pie_back_button),
                BACK_BUTTON, false);
        mHome = makeItem(R.drawable.ic_sysbar_home, res.getColor(R.color.pie_home_button),
                HOME_BUTTON, false);
        mRecent = makeItem(R.drawable.ic_sysbar_recent, res.getColor(R.color.pie_recent_button),
                RECENT_BUTTON, false);
