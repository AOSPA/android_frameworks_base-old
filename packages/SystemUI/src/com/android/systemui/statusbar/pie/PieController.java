...
public class PieController extends EdgeGestureManager.EdgeGestureActivationListener implements OnTouchListener, OnClickListener {
    ...
    private void addPieInLocation(int gravity) {
        ...
        // pie panel
        mPieControlPanel = new PieControlPanel(mContext);
    ...
    protected void setControlPanel(PieControlPanel panel) {
        mPanel = panel;
    ...
    private void populateMenu() {
        mBack = makeItem(R.drawable.ic_sysbar_back, BACK_BUTTON, true);
        mHome = makeItem(R.drawable.ic_sysbar_home, HOME_BUTTON, false);
        mRecent = makeItem(R.drawable.ic_sysbar_recent, RECENT_BUTTON, true);
        mMenu = makeItem(R.drawable.ic_sysbar_menu, MENU_BUTTON, false);
