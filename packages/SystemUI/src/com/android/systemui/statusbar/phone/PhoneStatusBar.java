    ...
    final private ContentObserver mHeadsUpObserver = new ContentObserver(mHandler) {
        ...
        public void onChange(boolean selfChange) {
            ...
            mHeadsUpTicker = mUseHeadsUp && 0 != Settings.System.getIntForUser(
                    ...
                    Settings.System.HEADS_UP_TICKER_OFF, UserHandle.USER_CURRENT);
            mUserDisabledHeadsUp = 1 != Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HEADS_UP_USER_ENABLED,
                    1 /* Add a gloabl on/off string in Settings.System */, UserHandle.USER_CURRENT);
            Log.d(TAG, "heads up is " + (mUseHeadsUp && !mUserDisabledHeadsUp ? "enabled" : "disabled"));
            if ((wasUsing != mUseHeadsUp) || mUserDisabledHeadsUp) {
                if (!mUseHeadsUp || mUserDisabledHeadsUp) {
...
//                    updateCarrierLabelVisibility(false);
    ...
    public void addNotification(StatusBarNotification notification, RankingMap ranking) {
        ...
        if (mUseHeadsUp && !zenBlocksHeadsUp && !mUserDisabledHeadsUp
