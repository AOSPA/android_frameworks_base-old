...
public class QuickSettingsTileFlipAnimator extends GestureDetector.SimpleOnGestureListener
implements View.OnTouchListener, TimeInterpolator {
    ...
    public QuickSettingsTileFlipAnimator(ViewGroup front, ViewGroup back) {
