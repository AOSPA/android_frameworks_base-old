...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    private final int IMMERSIVE_MODE_NAVBAR_HIDDEN = 2;
    private final int IMMERSIVE_MODE_STATUSBAR_HIDDEN = 3;
    ...
    private void onImmersiveChanged() {
        ...
        } else if (mode == IMMERSIVE_MODE_NAVBAR_HIDDEN) {
            mImmersiveState.iconId = R.drawable.ic_qs_immersive_on;
            mImmersiveState.label = r.getString(R.string.quick_settings_immersive_mode_navbar_hidden_label);
        } else if (mode == IMMERSIVE_MODE_STATUSBAR_HIDDEN) {
            mImmersiveState.iconId = R.drawable.ic_qs_immersive_on;
            mImmersiveState.label = r.getString(R.string.quick_settings_immersive_mode_statusbar_hidden_label);
        }
    ...
    protected void switchImmersiveModeStyles() {
        if (getImmersiveMode() == IMMERSIVE_MODE_OFF) {
            ...
            setImmersiveMode(IMMERSIVE_MODE_NAVBAR_HIDDEN);
        } else if (getImmersiveMode() == IMMERSIVE_MODE_NAVBAR_HIDDEN) {
            setImmersiveMode(IMMERSIVE_MODE_STATUSBAR_HIDDEN);
        } else if (getImmersiveMode() == IMMERSIVE_MODE_STATUSBAR_HIDDEN) {
