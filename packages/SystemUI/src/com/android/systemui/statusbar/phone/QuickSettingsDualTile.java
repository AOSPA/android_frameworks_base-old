...
class QuickSettingsDualTile extends QuickSettingsTileView {
    ...
    public QuickSettingsDualTile(Context context) {
        this(context, null);
    }

    public QuickSettingsDualTile(Context context, AttributeSet attrs) {
        super(context, attrs);
