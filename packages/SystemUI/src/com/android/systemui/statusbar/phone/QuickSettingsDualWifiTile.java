...
class QuickSettingsDualWifiTile extends QuickSettingsDualBasicTile {

    public QuickSettingsDualWifiTile(Context context) {
        this(context, null);
    }

    public QuickSettingsDualWifiTile(Context context, AttributeSet attrs) {
        super(context, attrs);
