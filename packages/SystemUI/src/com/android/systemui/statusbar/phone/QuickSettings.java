                ...
                if(Tile.USER.toString().equals(tile.toString())) { // User
                    ...
                    mHandler.postDelayed(new Runnable() {
                        @Override public void run() {
                            if (mModel.deviceSupportsLTE()) {
                                lteTile.setTemporary(false);
                                mModel.refreshLteTile();
                            } else {
                                lteTile.setTemporary(true);
                                lteTile.setVisibility(View.GONE);
                            }
                        }
                    }, 500);
                    ...
                    /*TODO Update lightbulb icon*/
                    lightbulbTile.setImageResource(R.drawable.ic_qs_location_on);
