            ...
            if(addTile) {
                if(Tile.USER.toString().equals(tile.toString())) { // User tile
                    ...
                    final QuickSettingsBasicTile wifiTileFront
                            = new QuickSettingsBasicTile (mContext);
                    final QuickSettingsBasicTile wifiTileBack
                            = new QuickSettingsBasicTile (mContext);
                    ...
                    wifiTileBack.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            boolean isOn = mModel.isWifiApEnabled();
                            if (isOn) {
                                mModel.setWifiApEnabled(false);
                                wifiTileBack.setImageResource(R.drawable.ic_qs_wifi_ap_on);
                                wifiTileBack.setTextResource(R.string.quick_settings_wifi_ap_label);
                            } else {
                                mModel.setWifiApEnabled(true);
                                wifiTileBack.setImageResource(R.drawable.ic_qs_wifi_ap_off);
                                wifiTileBack.setTextResource(R.string.quick_settings_wifi_ap_off_label);
                            }
                        }
                    });
                    ...
                    mModel.addWifiBackTile(wifiTileBack, new QuickSettingsModel.RefreshCallback() {
                        ...
                        public void refreshView(QuickSettingsTileView unused, State state) {
                            wifiTileBack.setImageResource(state.iconId);
                            wifiTileBack.setText(state.label);
                        }
                    });
                    parent.addView(wifiTile);
                    if(addMissing) wifiTile.setVisibility(View.GONE);
                } else if (mModel.deviceHasMobileData()) {
                    if(Tile.RSSI.toString().equals(tile.toString())) { // RSSI tile
                        final QuickSettingsBasicTile rssiTileFront
                            = new QuickSettingsBasicTile(mContext);
                        final QuickSettingsBasicTile rssiTileBack
                            = new QuickSettingsBasicTile(mContext);
                        final QuickSettingsFlipTile rssiTile
                            = new QuickSettingsFlipTile(mContext, rssiTileFront, rssiTileBack);
                        rssiTile.setTileId(Tile.RSSI);
                        // Front side (Turn on/off data)
                        rssiTileFront.setText(mContext.getString(R.string.quick_settings_network_type)
                        rssiTileFront.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                        ...
                        rssiTileFront.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                collapsePanels();
                                startSettingsActivity(
                        ...
                        mModel.addRSSITile(rssiTileFront, new NetworkActivityCallback() {
                            @Override
                            public void refreshView(QuickSettingsTileView view, State state) {
                                RSSIState rssiState = (RSSIState) state;
                                // Force refresh
                                rssiTileFront.setImageDrawable(null);
                                rssiTileFront.setImageResource(rssiState.signalIconId);

                                if (rssiState.dataTypeIconId > 0) {
                                    rssiTileFront.setImageResource(rssiState.dataTypeIconId);
                                } else {
                                    rssiTileFront.setImageResource(R.drawable.ic_qs_signal_data_off);
                                }
                                setActivity(view, rssiState);

                                rssiTileFront.setText(state.label);
                                rssiTileFront.setContentDescription(mContext.getResources().getString(
                        ...
                        rssiTileBack.setImageResource(R.drawable.ic_qs_unexpected_network);
                        rssiTileBack.setTextResource(R.string.quick_settings_network_unknown);
                        rssiTileBack.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                mModel.toggleMobileNetworkState();
                            }
                        });
                        rssiTileBack.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                Intent intent = new Intent(Intent.ACTION_MAIN);
                        ...
                        mModel.addMobileNetworkTile(rssiTileBack, new QuickSettingsModel.RefreshCallback() {
                            @Override
                            public void refreshView(QuickSettingsTileView unused, State mobileNetworkState) {
                                rssiTileBack.setImageResource(mobileNetworkState.iconId);
                                rssiTileBack.setText(mobileNetworkState.label);
                            }
                        });
                        parent.addView(rssiTile);
                        if(addMissing) rssiTile.setVisibility(View.GONE);
                    }
                } else if(Tile.ROTATION.toString().equals(tile.toString())) { // Rotation Lock Tile (Temporally flippable for testing)
                    if (mContext.getResources()
                            .getBoolean(R.bool.quick_settings_show_rotation_lock)
                                    || DEBUG_GONE_TILES) {
                        final QuickSettingsBasicTile rotationLockTileFront
                                = new QuickSettingsBasicTile(mContext);
                        final QuickSettingsBasicTile rotationLockTileBack
                                = new QuickSettingsBasicTile(mContext);
                        final QuickSettingsFlipTile rotationLockTile
                                = new QuickSettingsFlipTile(mContext, rotationLockTileFront, rotationLockTileBack);
                        rotationLockTile.setTileId(Tile.ROTATION); // TODO
                        rotationLockTileFront.setOnClickListener(new View.OnClickListener() {
                            @Override
                        ...
                        rotationLockTileFront.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                collapsePanels();
                                startSettingsActivity(
                                ...
                                new QuickSettingsModel.RefreshCallback() {
                                    ...
                                    public void refreshView(QuickSettingsTileView view,
                                        ...
                                        if (state.iconId != 0) {
                                            ...
                                            rotationLockTileFront.setImageDrawable(null);
                                            rotationLockTileFront.setImageResource(state.iconId);
                                        }
                                        if (state.label != null) {
                                            rotationLockTileFront.setText(state.label);
                                        }
                                    }
                                });

                        // This back tile (duplicated sleep one) is the sample for testing and integrate edit mode.
                        final PowerManager pm = (PowerManager) mContext.getSystemService(Context.POWER_SERVICE);

                        rotationLockTileBack.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                        ...
                        rotationLockTileBack.setImageResource(R.drawable.ic_qs_sleep_front);
                        rotationLockTileBack.setTextResource(R.string.quick_settings_sleep_label_front);
                    ...
                    if (mModel.deviceSupportsBluetooth()
                        ...
                        final QuickSettingsBasicTile bluetoothTileFront
                                = new QuickSettingsBasicTile(mContext);
                        final QuickSettingsBasicTile bluetoothTileBack
                                = new QuickSettingsBasicTile(mContext);
                        ...
                        mModel.addBluetoothTile(bluetoothTileFront,
                                new QuickSettingsModel.RefreshCallback() {
                            @Override
                            public void refreshView(QuickSettingsTileView unused, State state) {
                        ...
                        mModel.addBluetoothBackTile(bluetoothTileBack, new QuickSettingsModel.RefreshCallback() {
                            ...
                            public void refreshView(QuickSettingsTileView unused, State state) {
                                ...
                                bluetoothTileBack.setContentDescription(mContext.getString(
                                            R.string.accessibility_quick_settings_bluetooth,
                                            bluetoothState.stateContentDescription));
                                bluetoothTileBack.setText(state.label);
                    ...
                    final PowerManager pm = (PowerManager) mContext.getSystemService(Context.POWER_SERVICE);
                    final QuickSettingsBasicTile sleepTileFront
                    = new QuickSettingsBasicTile(mContext);
                    final QuickSettingsBasicTile sleepTileBack
                    = new QuickSettingsBasicTile(mContext);
                    final QuickSettingsFlipTile sleepTile
                    = new QuickSettingsFlipTile(mContext, sleepTileFront, sleepTileBack);
                    sleepTile.setTileId(Tile.SLEEP);
                    // Front side (Put device into sleep mode)
                    sleepTileFront.setImageResource(R.drawable.ic_qs_sleep_front);
                    sleepTileFront.setTextResource(R.string.quick_settings_sleep_label_front);
                    sleepTileFront.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            pm.goToSleep(SystemClock.uptimeMillis());
                        }
                    });
                    sleepTileFront.setOnLongClickListener(new View.OnLongClickListener() {
                        @Override
                        public boolean onLongClick(View v) {
                            collapsePanels();
                            startSettingsActivity(
                    ...
                    sleepTileBack.setImageResource(R.drawable.ic_qs_sleep_back);
                    mModel.screenTimeoutSetLabel(sleepTileBack);
                    sleepTileBack.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            mModel.screenTimeoutChangeState();
                            mModel.screenTimeoutSetLabel(sleepTileBack);
                        }
                    });
