...
public class NavigationBarView extends LinearLayout {
    ...
    private void updateCurrentView() {
        ...
        boolean needsAlternative = (rot == Surface.ROTATION_90 && !mSwapKeys) || (rot != Surface.ROTATION_90 && mSwapKeys);
        mNavigationInflaterView.setAlternativeOrder(needsAlternative);
