...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    protected boolean mUserDisabledHeadsUp = false; // Per-user heads up disabling override
    ...
    protected boolean shouldInterrupt(StatusBarNotification sbn) { // Here we are
        if (mNotificationData.shouldFilterOut(sbn)) { // System checks defaults like provisioned state
                                                      // and/or which user is to allow or not sensitive
                                                      // content, may wat to extend provisioning
                                                      // to a possible future hub.
            if (DEBUG) {
