...
public class HeadsUpStatusBarView extends AlphaOptimizedLinearLayout {
    ...
    public HeadsUpStatusBarView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        int customStartPadding = getResources().getDimensionPixelSize(R.dimen.heads_up_status_bar_padding_start);
        if (customStartPadding > 0) {
            mAbsoluteStartPadding = customStartPadding
