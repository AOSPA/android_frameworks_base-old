...
public final class NotificationEntry {
    ...
    public NotificationEntry(
        ...
        this.key = n.getKey();
        this.notification = n;
        this.mAppSecured = n.isAppPackageSecured();
        if (ranking != null) {
    ...
    public void populateFromRanking(@NonNull NotificationListenerService.Ranking ranking) {
        ...
        importance = (mAppSecured) ? IMPORTANCE_LOW : ranking.getImportance();
        ...
        canBubble = !mAppSecured && ranking.canBubble();
