...
private const val BURN_IN_PREVENTION_PERIOD = 1024f
...
class BurnInProtectionController @Inject constructor(
    ...
    private var shiftInterval : Int = context.resources.getInteger(R.integer.config_shift_interval) * 1000
