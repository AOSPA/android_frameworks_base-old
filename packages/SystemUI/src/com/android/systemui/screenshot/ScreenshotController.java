...
public class ScreenshotController {
    ...
    private boolean mCameraSoundForced = false;
...
>>>>>>> 84ab497183de (SystemUI: Screenshot: Append app name to filename)
    @Inject
    ScreenshotController(
        ...
        mCameraSoundForced = SystemProperties.getBoolean("audio.camerasound.force", false)
    ...
    private void playShutterSound() {
        ...
        boolean playSoundForced = mCameraSoundForced && mCamsInUse > 0;
