...
public class QSPanel extends LinearLayout implements Callback, BrightnessMirrorListener,
    ...
    protected ParanoidQSFooter mParanoidFooterView;
    ...
    private int mFooterBottomMargin;
    ...
    public QSPanel(
        ...
        mFooterBottomMargin = getResources().getDimensionPixelSize(
                R.dimen.paranoid_qs_footer_bottom_margin);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mParanoidFooterView != null) {
            height += getFooterHeight(false);
        }
    ...
    void setParanoidFooter(ParanoidQSFooter footer) {
        mParanoidFooterView = footer;
        mBrightnessController = new BrightnessController(mContext, 
                mParanoidFooterView.findViewById(R.id.brightness_icon),
                mParanoidFooterView.findViewById(R.id.brightness_slider), mBroadcastDispatcher);
        if (mParanoidFooterView.getSettingsButton() != null) {
            mParanoidFooterView.getSettingsButton().setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                   Dependency.get(ActivityStarter.class).postStartActivityDismissingKeyguard(
                            new Intent(android.provider.Settings.ACTION_SETTINGS), 0);
                }
            });
        } if (mParanoidFooterView.getEditButton() != null) {
            mParanoidFooterView.getEditButton().setOnClickListener(view ->
    ...
    public void updateBrightnessMirror() {
        if (mBrightnessMirrorController != null && mParanoidFooterView != null) {
            ToggleSliderView brightnessSlider = mParanoidFooterView.findViewById(R.id.brightness_slider);
            ...
            mParanoidFooterView.setMirror(mBrightnessMirrorController.getMirror());
        }
    }
    ...
    public void setExpanded(boolean expanded) {
        ...
        if (mBrightnessMirrorController != null) mBrightnessMirrorController.setExpanded(expanded);
    }
    ...
    public int getFooterHeight(boolean reduced) {
        if (mParanoidFooterView == null) {
            return 0;
        }
        MarginLayoutParams layoutParams = (MarginLayoutParams) mParanoidFooterView.getLayoutParams();
        return layoutParams.topMargin + ((reduced ? 2:1) * layoutParams.bottomMargin)
                + mParanoidFooterView.getMeasuredHeight();
    }
