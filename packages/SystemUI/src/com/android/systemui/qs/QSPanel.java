...
public class QSPanel extends LinearLayout implements Tunable, Callback, BrightnessMirrorListener,
    ...
    protected void addBrightnessView() {
        ...
        mBrightnessView.findViewById(R.id.slider).setProgressBackgroundTintMode(PorterDuff.Mode.SRC);
    ...
    public void updateBrightnessMirror() {
        if (mBrightnessMirrorController != null) {
            ...
            if (mBrightnessController != null) {
                ...
                mBrightnessMirror.findViewById(R.id.slider).setProgressBackgroundTintMode(PorterDuff.Mode.SRC);
            }
        }
    }
