...
public class QSPanel extends LinearLayout implements Tunable, Callback, BrightnessMirrorListener,
    ...
    private ToggleSeekBar mMirrorSlider;
    ...
    protected void addBrightnessView() {
        ...
        mSlider = mBrightnessView.findViewById(R.id.slider);
        mSlider.setProgressBackgroundTintMode(PorterDuff.Mode.SRC);
    ...
    public void updateBrightnessMirror() {
        if (mBrightnessMirrorController != null) {
            ...
            if (mBrightnessController != null) {
                ...
                mMirrorSlider = mBrightnessMirror.findViewById(R.id.slider);
                mMirrorSlider.setProgressBackgroundTintMode(PorterDuff.Mode.SRC);
            }
        }
    }
