...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    private void updateAnimator(int width) {
        ...
        float sideMargin = 0f;//mContext.getResources()
                //.getDimensionPixelOffset(R.dimen.qs_footer_brightness_margin);
        ...
        mBrightnessAnimator = new Builder()
                ...
                .addFloat(findViewById(R.id.brightness_slider), "translationX", isLayoutRtl()
                        ? -(iconSize + sideMargin)/2 : (iconSize + sideMargin)/2, 0)
                .addFloat(mBrightnessMirrorController.getMirror().findViewById(R.id.brightness_slider),
                        "translationX", isLayoutRtl() ? -(iconSize + sideMargin)/2 :(iconSize + sideMargin)/2, 0)
