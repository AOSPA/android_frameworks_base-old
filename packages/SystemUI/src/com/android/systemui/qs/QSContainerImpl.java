...
public class QSContainerImpl extends FrameLayout {
    ...
    private ParanoidQSFooter mParanoidFooter;
    ...
    protected void onFinishInflate() {
        ...
        mParanoidFooter = findViewById(R.id.paranoid_qs_footer);
        ...
        mQSPanel.setParanoidFooter(mParanoidFooter);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mHeader.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(mHeader.getMeasuredHeight()
                + mQSPanel.getFooterHeight(mIsLandscape && !mQQSMediaVisible), MeasureSpec.EXACTLY));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mParanoidFooter.updateAnimators();
    }
    ...
    public void updateExpansion(boolean animate) {
        ...
        if (!mQSCustomizer.isCustomizing()) {
            mParanoidFooter.setTranslationY(height - mParanoidFooter.getMeasuredHeight());
        }
