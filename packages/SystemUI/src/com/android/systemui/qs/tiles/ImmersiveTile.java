    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        switch (value) {
            case IMMERSIVE_FLAGS_FULL:
                state.icon = ResourceIcon.get(R.drawable.ic_immersive_full_enable_animation);
            ...
            case SYSTEM_DESIGN_FLAG_IMMERSIVE_NAV:
                state.icon = ResourceIcon.get(R.drawable.ic_immersive_nav_bar_enable_animation);
            ...
            case SYSTEM_DESIGN_FLAG_IMMERSIVE_STATUS:
                state.icon = ResourceIcon.get(R.drawable.ic_immersive_status_bar_enable_animation);
