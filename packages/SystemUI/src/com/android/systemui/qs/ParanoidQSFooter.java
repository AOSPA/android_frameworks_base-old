...
public class ParanoidQSFooter extends LinearLayout {
    ...
    public ParanoidQSFooter(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mFooterActions = findViewById(R.id.paranoid_qs_footer_actions);
