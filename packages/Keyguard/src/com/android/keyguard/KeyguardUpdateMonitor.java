...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private void updateFingerprintListeningState() {
        ...
        boolean running = mFingerprintRunningState == FINGERPRINT_STATE_RUNNING;
        ...
        if (mPowerKeyEmbeddedFingerprintSensorPolicy && !running) {
        ...
        if (running && !shouldListenForFingerprint) {
            ...
            if (mPowerKeyEmbeddedFingerprintSensorPolicy && mPowerKeyPressed) {
    ...
    private void handleOnPowerKeyEvent(boolean up, int repeatCount) {
        ...
        if (changed && !mPowerKeyPressed && mPendingFingerprintStart) {
            mPendingFingerprintStart = false;
            mHandler.sendEmptyMessageDelayed(MSG_UPDATE_FINGERPRINT_STATE, 1000);
            updateFingerprintListeningState();
        }
    }
